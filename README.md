...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `36.9µs` | `57.8µs` |
| [Day 2](./src/bin/02.rs) | `94.5µs` | `161.2µs` |
| [Day 3](./src/bin/03.rs) | `92.2µs` | `57.9µs` |
| [Day 4](./src/bin/04.rs) | `278.2µs` | `33.6µs` |
| [Day 5](./src/bin/05.rs) | `837.1µs` | `22.8ms` |
